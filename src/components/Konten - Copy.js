      ...
      <div className=" w-full h-4/5">
        <Carousel slide={false}>
          <div className=" w-10/12 flex justify-center items-center">
            <div className="pl-6 tracking-normal mb-8">
              <h1 className=" font-bold text-2xl tracking-widest uppercase text-white pb-6">
                Registrasi
              </h1>
              <div className=" w-10/12 p-6 text-white text-sm bg-slate-400/10 backdrop-blur-lg rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
            ...
            <img src={group1} alt="..." className=" w-2/5 pr-6 " />
          </div>
          ...
          <div className=" w-10/12 flex justify-center items-center">
            ...
            <img src={group2} alt="..." className=" w-2/5 pr-6 " />
          </div>
        </Carousel>
      </div>
    </Dashboard>
